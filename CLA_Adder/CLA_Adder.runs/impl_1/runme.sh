...
HD_PWD='/home/yagiz/Documents/PROJELER/CLA_Adder/CLA_Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CSA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CSA.tcl -notrace
