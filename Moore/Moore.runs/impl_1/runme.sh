...
HD_PWD='/home/yagiz/Documents/PROJELER/Moore/Moore.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Moore.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Moore.tcl -notrace
